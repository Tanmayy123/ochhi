...
function Footer() {
  return (
    <div className="w-full flex gap-7 h-screen p-20 bg-zinc-100">
      <div className="w-1/2 flex flex-col justify-between h-full ">
        <div className="heading">
          <h1 className="uppercase text-9xl leading-none tracking-tighter -mb-8 font-semibold text-black">
            eye-
          </h1>
          <h1 className="uppercase text-9xl leading-none tracking-tighter -mb-8 font-semibold text-black">
            Opening
      ...
      <div className="text-black">
        <h1 className="uppercase text-7xl px-10 leading-none tracking-tighter -mb-8 font-semibold text-black">
          Presentations
        </h1>
      </div>
    </div>
